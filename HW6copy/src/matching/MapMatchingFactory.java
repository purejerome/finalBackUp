...
/**
 * Factory to match gps points to best line segment.
    ...
    StreetSegment>, Point2D.Double>
{
  ...
  /**
   * Creates new mao matching factory.
   * @param surroundingSegments - Surrounding segments to check.
   * @param currentPosition - Latest gps postion.
   * @param inertia - History of previous gps postions.
   */
  public MapMatchingFactory(final HashSet<StreetSegment> surroundingSegments,
      final Point2D.Double currentPosition, final Queue<Point2D.Double> inertia)
  {
